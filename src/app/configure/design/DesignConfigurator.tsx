...
import { ChevronsUpDown, CheckIcon, ArrowRight } from "lucide-react";
import { COLORS, MODELS, MATERIALS, FINISHES, BASE_PRICE } from "@/constants";
...
function DesignConfigurator({
  ...
  return (
    <div className="relative grid lg:grid-cols-3 grid-cols-1 my-20 pb-20">
      <div
        ref={containerRef}
        className="overflow-hidden relative lg:col-span-2 col-span-full flex items-center justify-center border-dashed border-2 border-gray-300 text-center p-12 rounded-lg w-full h-[37.5rme] max-w-4xl focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831] ">
          ...
          <div
            className={cn(
              "absolute inset-0 top-px bottom-px left-[3px] right-[3px] rounded-[32px]",
              `bg-${options.color.tw}`
            )}
          />
        </div>
